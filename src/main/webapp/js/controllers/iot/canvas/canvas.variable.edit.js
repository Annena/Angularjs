app.controller('VariableEditCtrl', ['$scope','$state','$http','point','$stateParams',"$timeout", function($scope,$state,$http,point,$stateParams,$timeout) {
...
//取消    
    $scope.cancel = function(){
    	...
    	$scope.$emit("VariableEditOver", $scope.msg);
    };
...
//修改
    ...
    $scope.$on("EditVariableFromCanvas",function(event,msg){
    	$scope.msg = msg;
    	$scope.id = msg.variable.id;
